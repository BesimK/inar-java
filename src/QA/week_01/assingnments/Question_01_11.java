package QA.week_01.assingnments;
...
public class Question_01_11 {
    public static void main(String[] args) {
        ...
        System.out.println(312032486 + ((31536000.0 / 7)
                - (31536000.0 / 13)
                + (31536000.0 / 45)));
        System.out.println("Year 2 projection: ");
        System.out.println(3.148125827032967E8 + (((31536000.0 / 7)
                - (31536000.0 / 13)
                + (31536000.0 / 45))));
        System.out.println("Year 3 projection: ");
        System.out.println(3.1759267940659344E8 + (((31536000.0 / 7)
                - (31536000.0 / 13)
                + (31536000.0 / 45))));
        System.out.println("Year 4 projection: ");
        System.out.println(3.2037277610989016E8 + (((31536000.0 / 7)
                - (31536000.0 / 13)
                + (31536000.0 / 45))));
        System.out.println("Year 5 projection: ");
        System.out.println(3.231528728131869E8 + (((31536000.0 / 7)
                - (31536000.0 / 13)
                + (31536000.0 / 45))));
    }
}
