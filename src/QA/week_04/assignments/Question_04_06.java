...
public class Question_04_06 {
    public static void main(String[] args) {
        ...
        double sideABetweenPoint1AndPoint2 = Math.sqrt(Math.pow(xOfPoint1 - xOfPoint2, 2)
                + Math.pow(yOfPoint1 - yOfPoint2, 2));


        double sideBBetweenPoint2AndPoint3 = Math.sqrt(Math.pow(xOfPoint2 - xOfPoint3, 2)
                + Math.pow(yOfPoint2 - yOfPoint3, 2));


        double sideCBetweenPoint1AndPoint3 = Math.sqrt(Math.pow(xOfPoint1 - xOfPoint3, 2)
