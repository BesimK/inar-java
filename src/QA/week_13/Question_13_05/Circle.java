package QA.week_13.Question_13_05;
...
public class Circle extends GeometricObject implements Comparable<GeometricObject>{
    ...
    @Override
    public boolean equals(QA.week_13.Question_13_05.GeometricObject o){
        return this.radius==((Circle)o).getRadius();
    }
    @Override
    public int compareTo(QA.week_13.Question_13_05.GeometricObject o){
        return (this.getArea()>((Circle)o).getArea())? 1 : (this.getArea()==((Circle)o).getArea())? 0 : -1;
    }
}